...
class Clientes extends CI_Controller {
	...
	function gerenciar(){
	    ...
	    $this->data['results'] = $this->clientes_model->get('clientes','idClientes,nomeCliente,documento,telefone,celular,email,rua,numero,bairro,cidade,estado,cep,complemento','',$config['per_page'],$this->uri->segment(3));
