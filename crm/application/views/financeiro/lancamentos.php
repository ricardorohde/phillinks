	            ...
	            <?php foreach ($contas as $item) { ?>
	              <?php if($item["id"] != 1){ ?>
	                <tr>
	                  ...
	                  <td>
	                    <center>
	                      <a href="<?php echo base_url('contas/gerenciar'); ?>" class="btn btn-info tip-top" title="Gerenciar">
...
<div id="modalReceita" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
  		...
  		<div class="span12 alert alert-warning" style="margin-left: 0"> Obrigatório o preenchimento dos campos com asterisco.</div>
    	<div class="span12" style="margin-left: 0">
    	...
    	<div class="span12" style="margin-left: 0">
    		<div class="span8" style="margin-left: 0">
    			...
    			<select class="span12" required id="id_conta" name="id_conta">
            <option value="" disabled selected>Selecione</option>
            <?php foreach($contas as $conta){ ?>

              <option value="<?php echo $conta["id"]; ?>" <?php if($conta["status"] == 0) echo 'disabled' . ' title="Caixa Fechado"'; ?>><?php echo $conta["nome"]; ?></option>
    	...
    	<div class="span12" style="margin-left: 0">
        <label class="checkbox" for="recebido">
        <input id="recebido" type="checkbox" name="recebido" value="1" />	Confirmo que recebi o valor pago.
        </label>
      </div>
      <div id="divRecebimento" class="" style="display: none; margin-left: 0;">
        <div class="span6">
...
<div id="modalDespesa" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
    	...
    	<div class="span12" style="margin-left: 0">
    		<div class="span8" style="margin-left: 0">
    			<label for="conta">Conta Débito*</label>
    			<select class="span12" required id="id_conta" name="id_conta">
            <option value="" disabled selected>Selecione</option>
						<?php foreach($contas as $conta){ ?>
    	...
    	<div class="span12" style="margin-left: 0">
    		<div class="span12" style="margin-left: 0">
          <label class="checkbox" for="pago">
	    		<input id="pago" type="checkbox" name="pago" value="1" />	Confirmo que esta despesa está paga.
	    		</label>
    		</div>
  ...
  <div class="modal-body">
      ...
      <div class="span12" style="margin-left: 0">
    		<div class="span8" style="margin-left: 0">
    			...
    			<select class="span12" required id="id_contaEditar" name="id_conta">
            <?php foreach($contas as $conta){?>
...
<script type="text/javascript">
    ...
    $('#pagoEditar').click(function(event) {
      ...
      messages: {
        ...
        id_conta: {required: 'Campo Requerido.'}
      }
    });
    ...
    $(document).on('click', '.editar', function(event) {
      ...
      $("#id_contaEditar").val($(this).attr('id_conta'));
