...
<div class="row-fluid" style="margin-top:0">
    <div class="span12">
        <a href="<?php echo base_url("vendas/gerenciar"); ?>" class="btn btn-default"><i class="icon-arrow-left icon-white"></i> Voltar</a>
        <div class="widget-box">
            ...
            <div class="widget-content nopadding" style="min-height: 200px;">
                ...
                <form action="<?php echo current_url(); ?>" method="post" id="formVendas">
                  ...
                  <div class="span12" style="padding: 1%">
                    ...
                    <div class="span5">
                      ...
                      <input id="cliente" class="span12" type="text" name="cliente" value="**VENDA NO BALCÃO**"  />
                      <input id="clientes_id" class="span12" type="hidden" name="clientes_id" value="0"  />
                    </div>
                    <div class="span5">
                      <label for="tecnico">Vendedor<span class="required">*</span></label>
                      <input id="tecnico" class="span12" type="text" name="tecnico" value="<?php echo $this->session->userdata("nome") . ' | Telefone: ' . $this->session->userdata("telefone"); ?>"  />
